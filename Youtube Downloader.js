...
// @version     5.2
// @date        2019-10-09
// @description i've(SparkleOfMadness YT) changed the settings to download with another server.
// @author      DistillVideo.com + Neil
...
function Addytpolymer() {
    ...
    addButton.style.backgroundColor = "#eb1515";
    ...
    addButton.href = "https://loader.to/?link=" + window.location.href + "&f=720&s=1&e=21&r=self"; 
